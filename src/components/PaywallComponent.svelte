...
<Card class="w-full max-w-2xl mx-auto p-6 space-y-6">
  ...
  <ul class="space-y-2">
    <li class="flex items-center">
      <Check class="text-green-500 mr-2" />
  ...
  <Button class="w-full bg-red-600 hover:bg-red-700 text-white">Fortsätt</Button>
